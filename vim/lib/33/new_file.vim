...
function! s:nf_python(line)
    ...
    let l:l = s:append(l:l, '#! /usr/bin/env python')
    ...
    let l:l = s:append(l:l, '')
    let l:l = s:append(l:l, '')
    let l:l = s:append(l:l, 'def main(opts, args):')
    let l:p = l:l
    ...
    let l:l = s:append(l:l, '        (opts, args) = get_options()')
    let l:l = s:append(l:l, '        exit(main(opts, args))')
    let l:l = s:append(l:l, '    except KeyboardInterrupt as exc:')
    let l:l = s:append(l:l, '        sys.stderr.write("\033[1;31moperation cancelled by user\033[0m\n")')
    let l:l = s:append(l:l, '        exit(-1)')
    let l:l = s:append(l:l, '    except Exception as exc:')
...
function! s:nf_golang(line)
    ...
    let l:l = s:append(l:l, '    "context"')
    let l:l = s:append(l:l, '    "errors"')
    ...
    let l:l = s:append(l:l, 'var _ = context.Canceled')
    let l:l = s:append(l:l, 'var _ = errors.New')
