...
function! s:ld_python(line)
    ...
    let l:l = s:ld_append(l:l, '')
    let l:l = s:ld_append(l:l, '')
    let l:l = s:ld_append(l:l, 'def main(options, args):')
    ...
    let l:l = s:ld_append(l:l, '')
    let l:l = s:ld_append(l:l, '    return parser.parse_args()')
    let l:l = s:ld_append(l:l, '')
    let l:l = s:ld_append(l:l, '')
    let l:l = s:ld_append(l:l, 'if __name__ == "__main__":')
    let l:l = s:ld_append(l:l, '    (options, args) = get_options()')
    let l:l = s:ld_append(l:l, '    exit(main(options, args))')
